...
const CreateFacultativoModal: React.FC<CreateFacultativoModalProps> = ({ isOpen, onClose, onSuccess }) => {
    ...
    const onSubmit = async (data: FacultativoFormValues) => {
        ...
        try {
            ...
            setIsSubmitting(false); // Only reset if error, otherwise keep true for success
        }
    };
            ...
            <div className="relative bg-white dark:bg-slate-800 w-full max-w-3xl rounded-[32px] shadow-2xl border border-slate-100 dark:border-slate-700 overflow-hidden animate-in zoom-in-95 fade-in duration-300 max-h-[90vh] flex flex-col">
                ...
                {isSubmitting && !success ? (
                    <div className="flex flex-col items-center justify-center py-24 animate-in fade-in duration-300">
                        ...
                        <h4 className="text-xl font-bold text-slate-900 dark:text-white">Creando facultativo...</h4>
                    ...
                    <div className="flex flex-col items-center justify-center py-24 animate-in zoom-in duration-500">
                        ...
                        <h4 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Facultativo creado</h4>
